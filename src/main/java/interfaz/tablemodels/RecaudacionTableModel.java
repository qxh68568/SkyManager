...
public class RecaudacionTableModel extends AbstractTableModel {
    ...
    public RecaudacionTableModel(List<VueloDiario> listaVuelos) {
    ...
    public float filtrarPorFecha(Date fecha) {
        SimpleDateFormat formatoFecha = new SimpleDateFormat("dd-MM-yyyy");
        if (fecha != null) {
        ...
        for (VueloDiario vuelo : listaVuelosDiariosFiltradosAeropuertoFecha) {
            totalRecaudacion += vuelo.calcularRecaudacion();
        }
        return totalRecaudacion;
    }

    public void inicializarListaFiltradaRecaudacion() {
        listaVuelosDiariosFiltradosAeropuertoFecha = new ArrayList<>();
        fireTableDataChanged();
    }
