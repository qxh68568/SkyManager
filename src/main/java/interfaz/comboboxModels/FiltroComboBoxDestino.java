...
public class FiltroComboBoxDestino extends DefaultComboBoxModel<Aeropuerto> {
    
    private List<Aeropuerto> datosOriginales;
    
    public FiltroComboBoxDestino(List<Aeropuerto> datos) {
        super(datos.toArray(new Aeropuerto[1]));
    ...
    public void filtrarDatos(String texto) {
      ...
      @Override
            public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                if (value instanceof Aeropuerto destino) {
